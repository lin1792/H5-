(function() {
  ...
  Mdate.prototype = {
      ...
      createDateUi: function() {
          var str = "" + '<section class="getDateBg"></section>' + '<section class="getDateBox" id="getDateBox">' + '<div class="choiceDateTitle">' + '<button id="dateCancel">取消</button>' + '<button id="dateSure" class="fr">确定</button>' + "</div>" + '<div id="text">' + '<span>年</span>' + '<span>月</span>' + '<span>日</span>' + '</div>' + '<div class="dateContent">' + '<div class="checkeDate"></div>' + '<div id="yearwrapper">' + '<ul id="yearUl"></ul>' + "</div>" + '<div id="monthwrapper">' + '<ul id="monthUl"></ul>' + "</div>" + '<div id="daywrapper">' + '<ul id="dayUl"></ul>' + "</div>" + "</div>" + "</section>";
      ...
      initScroll: function() {
          ...
          yearScroll = new iScroll("yearwrapper",{
              ...
              onScrollEnd: function() {
                  indexY = Math.ceil(this.y / 20 * -1 + 2);
          ...
          monthScroll = new iScroll("monthwrapper",{
              ...
              vScrollbar: false,
              onScrollEnd: function() {
                  indexM = Math.ceil(this.y / 20 * -1 + 2);
          ...
          dayScroll = new iScroll("daywrapper",{
              ...
              vScrollbar: false,
              onScrollEnd: function() {
                  indexD = Math.ceil(this.y / 20 * -1 + 2);
                  if (indexD == 2 && monthTag != that.beginMonth) {
                      dayTag = 2
                  } else {
                      dayTag = dayUl.getElementsByTagName("li")[indexD].getAttribute("data-day")
                  }
      ...
      refreshScroll: function() {
          ...
          inputDay -= initD;
          yearScroll.refresh();
          yearScroll.scrollTo(0, inputYear * 20, 300, true);
          monthScroll.scrollTo(0, inputMonth * 20, 300, true);
          dayScroll.scrollTo(0, inputDay * 20, 300, true)
      },
      dateSure: function() {
          var that = this;
